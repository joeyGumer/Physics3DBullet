...
void ModulePhysics3D::CreateP2PConstraint(PhysBody3D* pbA, PhysBody3D* pbB, const vec3& pivotA, const vec3& pivotB)
{
	btVector3 pointA(pivotA.x, pivotA.y, pivotA.z);
	btVector3 pointB(pivotB.x, pivotB.y, pivotB.z);

	btPoint2PointConstraint* P2Pconstraint = new btPoint2PointConstraint(*pbA->body, *pbB->body, pointA, pointB);
